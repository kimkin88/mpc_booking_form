...
export const DEFAULT_FIELD_PERMISSIONS = {
  ...
  files: 'editable',
  calculated_delivery_date: 'readonly',
  ...
  half_day_rate: 'hidden',
  full_day_rate: 'hidden',
  rate_card_label: 'hidden',
...
export const BOOKING_SECTIONS = [
  {
    ...
    fields: ['brand', 'campaign_name', 'city_market', 'sb_number', 'budget', 'currency', 'po_number'],
  },
  {
    key: 'contact',
